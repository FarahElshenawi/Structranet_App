...
// Exact same system from the reference design file

export const Icon = ({ d, size = 16, strokeWidth = 1.5, style = {} }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const NetworkIcon = ({ size = 18 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const PATHS = {
  ...
  server: "M2 3h20v14H2zM8 21h8M12 17v4",
